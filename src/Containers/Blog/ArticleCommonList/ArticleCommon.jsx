                ...
                <div className="flex justify-between items-center h-16 p-4 my-6  rounded-lg border border-gray-100">
                    <div className="flex items-center">
                        ...
                        <div className="ml-8">
                            ...
                            <div className="hidden lg:flex lg:items-center lg:w-auto text-sm font-light italic text-blue-congreso200">Frase inspiracional delasdfasfasffsafasdfsfsfasfjhgkjhgkjhgkjhgkjh jhgkjhgkjhg kjhgkjhgkjhg autor (pendiente)</div>
                        </div>
                        <div>
                            <a href={`/articulos/${item.id}#article-detail-comments`} className="text-red-congreso100 hover:text-red-congreso200 text-lg">
                                <button className="hover:bg-blue-congreso p-2 rounded-full shadow-md flex justify-center items-center">
